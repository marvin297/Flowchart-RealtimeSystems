...
class App(customtkinter.CTk):
    ...
    def create_sidebar(self):
        ...
        task_name_frame = Frame(GeneralVariables.sidebar, bd=0, bg="#2A2A2A", height=30)
        ...
        task_name_input = Entry(task_name_frame, font=("Montserrat Light", 10), bd=0, bg="#303030", fg="white",
                                insertbackground="white", width=20, textvariable=GeneralVariables.sidebar_task_input, borderwidth=10, relief="flat")
        task_name_input.pack(side=TOP, anchor=N, padx=15, pady=15)

        activity_name_frame = Frame(GeneralVariables.sidebar, bd=0, bg="#2A2A2A", height=30)
        ...
        activity_name_input = Entry(activity_name_frame, font=("Montserrat Light", 10), bd=0, bg="#303030", fg="white",
                                    insertbackground="white", width=20, textvariable=GeneralVariables.sidebar_activity_input, borderwidth=10, relief="flat")
        activity_name_input.pack(side=TOP, anchor=N, padx=15, pady=15)

        cycles_frame = Frame(GeneralVariables.sidebar, bd=0, bg="#2A2A2A", height=30)
        ...
        cycles_input = Entry(cycles_frame, font=("Montserrat Light", 10), bd=0, bg="#303030", fg="white",
                                    insertbackground="white", width=20, textvariable=GeneralVariables.sidebar_cycles_input, borderwidth=10,
                                    relief="flat")
        cycles_input.pack(side=TOP, anchor=N, padx=15, pady=15)

        # Create a frame to simulate the button appearance
        button_frame = Frame(GeneralVariables.sidebar, bg="#303030", bd=1, relief="solid",
        ...
        button_label = Button(button_frame, text="CONFIRM SETTINGS", fg="white", bg="#303030", bd=0,
                              font=("Montserrat Light", 12), command=lambda: GeneralVariables.confirm_task_change(), width=20)
        button_label.pack()
